        ...
        <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            <form method="post" onSubmit={(e) => e.preventDefault()}>
              ...
              <button
                onClick={() => createItem()}
                className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-[#f59e0b] bg-[#422006] hover:bg-[#341402] active:bg-[#341402] rounded-lg ring-offset-2 ring-gray-600 focus:ring-2"
              >
                Add Tracking
              </button>
            </form>
